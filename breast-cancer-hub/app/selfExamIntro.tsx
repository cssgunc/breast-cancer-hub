        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          <ThemedView style={styles.whiteOverlay}>
            ...
            {examTypeF ? (
              ...
              //     <ThemedText style={styles.instructionTextBold}>1.</ThemedText>
              //     <ThemedText style={styles.instructionText}>{info_f[0]}</ThemedText>
              //   </ThemedView>
              //   <ThemedView style={styles.listItemContainer}>
              //     <ThemedText style={styles.instructionTextBold}>2.</ThemedText>
              //     <ThemedText style={styles.instructionText}>Skin irritation or dimpling (sometimes looking like an orange peel).</ThemedText>
              //   </ThemedView>
              //   <ThemedView style={styles.listItemContainer}>
              //     <ThemedText style={styles.instructionTextBold}>3.</ThemedText>
              //     <ThemedText style={styles.instructionText}>Breast or nipple pain.</ThemedText>
              //   </ThemedView>
              //   <ThemedView style={styles.listItemContainer}>
              //     <ThemedText style={styles.instructionTextBold}>4.</ThemedText>
              //     <ThemedText style={styles.instructionText}>Nipple retraction (turning inward).</ThemedText>
              //   </ThemedView>
              //   <ThemedView style={styles.listItemContainer}>
              //     <ThemedText style={styles.instructionTextBold}>5.</ThemedText>
              //     <ThemedText style={styles.instructionText}>Swelling of part or all of a breast.</ThemedText>
              //   </ThemedView>
              //   <ThemedView style={styles.listItemContainer}>
              //     <ThemedText style={styles.instructionTextBold}>6.</ThemedText>
              //     <ThemedText style={styles.instructionText}>Swelling of part or all of a breast.</ThemedText>
              //   </ThemedView>
              // </ThemedView>
            ) : (
